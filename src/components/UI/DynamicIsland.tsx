    ...
    <div className="fixed top-0 left-1/2 -translate-x-1/2 z-[200] flex flex-col items-center pt-2 pointer-events-none">
      <motion.div 
        ...
        className={cn(
          ...
          isExpanded 
            ? "w-[420px] rounded-[44px] p-6 cursor-default" 
            : "w-[220px] h-[32px] rounded-full flex items-center justify-center cursor-pointer"
        )}
        style={{
            ...
            >
              ...
              {context.isMusicPlaying && (
                <div className="flex items-center gap-2 bg-white/5 px-2 py-0.5 rounded-full border border-white/10">
                  ...
                  <span className="text-[8px] font-bold uppercase tracking-widest text-stone-400">Axis Radio</span>
                </div>
              )}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-base font-bold text-white tracking-tight">
                      {context.isMusicPlaying ? "Axis Radio - LoFi" : "Sentinel Directive"}
                    </span>
                  </div>
                </div>
                <motion.button 
