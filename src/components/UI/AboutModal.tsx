  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <motion.div 
        ...
        className="w-[90vw] md:w-[600px] h-[80vh] md:h-[400px] liquid-glass rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-white/20"
      >
        {/* Sidebar */}
        <div className="w-full md:w-[200px] bg-black/20 border-b md:border-b-0 md:border-r border-white/10 p-4 flex flex-row md:flex-col items-center">
          <div className="w-12 h-12 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 mb-0 md:mb-4 overflow-hidden border-2 border-white/20 shadow-lg">
            <img 
          ...
          <div className="ml-4 md:ml-0 text-left md:text-center">
            <h2 className="text-sm md:text-lg font-semibold text-white">Lana Del Rey</h2>
            <p className="text-[10px] md:text-xs text-white/50 mb-0 md:mb-6">Administrator</p>
          </div>
