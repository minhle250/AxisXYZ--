...
const DockItem = ({ app, mouseX, onClick }: { app: any, mouseX: any, onClick: () => void }) => {
  ...
  return (
    <motion.button
      ...
      className="liquid-glass-panel rounded-2xl flex items-center justify-center text-stone-200 hover:text-white transition-colors shadow-sm focus:outline-none"
    >
